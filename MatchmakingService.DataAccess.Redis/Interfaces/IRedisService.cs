...
public interface IRedisService
{
    ...
    Task<IReadOnlyCollection<T>> GetAsync<T>(IReadOnlyCollection<string> keys, CancellationToken cancellationToken)
        where T : class;
    ...
    Task<IReadOnlyCollection<string>> SortedSetGetRangeAsync(string key, double minScore, double maxScore,
